...
namespace PlayerManager4
{
    ...
    public class Program
    {
        ...
        private static void ListPlayers(IEnumerable<Player> playersToList)
        {
            ...
            Console.WriteLine("List by score(1),alphabetic(2),inverse(3)");
            Console.WriteLine("-------------\n");
            string option = Console.ReadLine();
            CompareByName compareByName;
            Player[] playersToListArray = playersToList.ToArray();
            ...
            switch (option)
            {
                ...
                case "2":
                    ...
                    Array.Sort(playersToListArray, compareByName);

                    foreach (Player p in playersToListArray)
                    {
                        Console.WriteLine($" -> {p.Name} with a score of {p.Score}");
                    }
                ...
                case "3":
                    ...
                    compareByName = new CompareByName(false);
                    Array.Sort(playersToListArray, compareByName);
